...
public class OrdersController {
	...
	@Transactional
	public ResponseEntity<String> updateOrderStatus(@PathVariable("status") String status, @PathVariable("id") long id) {
		String str = null;
		try {
	...
	public List<Orders> showByOrderDate(@PathVariable("date") LocalDate date) {
		List<Orders> orders = service.listAllOrdersByOrderDate(date);
		return orders;
	}
	...
	public List<Orders> showAllCustomerOrdersByStatus(@PathVariable String status, @PathVariable long id) {
		return service.listByOrderStatusForCustomer(status, id);
	}
	
	@GetMapping("/orders/admin/{status}")
	public List<Orders> showAllByStatus(@PathVariable String status) {
