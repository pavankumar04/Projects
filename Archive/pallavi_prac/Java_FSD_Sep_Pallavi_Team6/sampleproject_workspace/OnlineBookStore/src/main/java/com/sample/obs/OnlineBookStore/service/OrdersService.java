...
public class OrdersService {
	 ...
	 * @return String
	 */
	public String updateOrderStatus(String status, long id) throws ResourceNotFoundException{
	...
	public List<Orders> listByOrderStatusForCustomer(String status, long id) {
		return repo.listByOrderStatusForCustomer(status, id);
	}
	
	public List<Orders> listByOrderStatusAdmin(String status) {
