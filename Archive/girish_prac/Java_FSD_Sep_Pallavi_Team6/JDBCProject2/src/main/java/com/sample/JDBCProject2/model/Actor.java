package com.sample.JDBCProject2.model;
...
public class Actor {
	...
	public Actor(int actorId, String firstName, String lastName, LocalDate dob, String phone, double fees, Gender gender) {
		this.actorId = actorId;
		this.firstName = firstName;
		this.lastName = lastName;
		this.dob = dob;
	...
	public String addNewActor(String fName, String lName, String ph, double sal, LocalDate birthDate, String gen) {
		...
		if(gen.equals(Gender.MALE.name()) || gen.equals(Gender.FEMALE.name())) {
			res = ActorFactory.addNewActor(fName, lName, ph, fees, sqlDate, gen);
			if(res > 0) {
